---
title: "Get all transactions for the current user"
api: "GET /v1/transactions"
description: "Retrieve paginated transaction history with optional status filtering. Use status=pending to get all non-completed transactions, or status=completed to get only completed transactions. Omit status parameter to get all transactions."
---

## Overview

Retrieve paginated transaction history with optional status filtering. Use status=pending to get all non-completed transactions, or status=completed to get only completed transactions. Omit status parameter to get all transactions.
