...
api: "GET /v1/api-keys/logs"
description: "Get API key usage logs"
---
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/api-keys/logs \
  -H "X-API-Key: your-api-key-here"
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/api-keys/logs', {
  method: 'GET',
  headers: {
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/api-keys/logs',
