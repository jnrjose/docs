...
```bash cURL
curl -X PATCH https://api.railsfromthecrypt.com/v1/api-keys/{id}/label \
...
const response = await fetch('https://api.railsfromthecrypt.com/v1/api-keys/{id}/label', {
  method: 'PATCH',
  headers: {
...
response = requests.patch(
    'https://api.railsfromthecrypt.com/v1/api-keys/{id}/label',
