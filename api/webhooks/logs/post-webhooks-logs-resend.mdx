---
title: "Resend failed webhook"
api: "POST /v1/webhooks/logs/resend"
description: "Resend a failed webhook log entry immediately"
---

## Overview

Resend a failed webhook log entry immediately
...
<ResponseField name="message" type="string">
  Webhook resend failed - service unavailable
</ResponseField>
