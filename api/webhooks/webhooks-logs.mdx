---
title: "Get webhook logs for the current client"
api: "GET /v1/webhooks/logs"
description: "Retrieve all webhook logs for the current client with filtering and pagination"
---

## Overview

Retrieve all webhook logs for the current client with filtering and pagination
...
<ParamField query="http_code" type="number" >
  Http Code
</ParamField>
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/webhooks/logs \
  -H "X-API-Key: your-api-key-here"
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/webhooks/logs', {
  method: 'GET',
  headers: {
