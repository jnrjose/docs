...
api: "PATCH /v1/webhooks/{id}/status"
description: "Enable or disable webhook manually"
---

## Overview

Enable or disable webhook manually
...
<ResponseField name="data" type="object">
  Response data (WebhookResponseDto)
</ResponseField>
...
<ResponseField name="message" type="string">
  Webhook is already in the requested status
</ResponseField>
...
```bash cURL
curl -X PATCH https://api.railsfromthecrypt.com/v1/webhooks/{id}/status \
...
const response = await fetch('https://api.railsfromthecrypt.com/v1/webhooks/{id}/status', {
  method: 'PATCH',
  headers: {
...
response = requests.patch(
    'https://api.railsfromthecrypt.com/v1/webhooks/{id}/status',
