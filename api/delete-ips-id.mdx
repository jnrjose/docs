---
title: "Delete an IP whitelist entry"
api: "DELETE /v1/ips/{id}"
description: "Soft delete an IP whitelist entry by ID"
---

## Overview

Soft delete an IP whitelist entry by ID
...
```bash cURL
curl -X DELETE https://api.railsfromthecrypt.com/v1/ips/{id} \
