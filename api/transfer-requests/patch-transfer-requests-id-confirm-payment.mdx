---
title: "Confirm payment for transfer request"
api: "PATCH /v1/transfer-requests/{id}/confirm-payment"
description: "Confirm payment for transfer request"
---
...
```bash cURL
curl -X PATCH https://api.railsfromthecrypt.com/v1/transfer-requests/{id}/confirm-payment \
  -H "X-API-Key: your-api-key-here" \
  -H "Content-Type: application/json"
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/transfer-requests/{id}/confirm-payment', {
  method: 'PATCH',
  headers: {
...
response = requests.patch(
    'https://api.railsfromthecrypt.com/v1/transfer-requests/{id}/confirm-payment',
