---
title: "Get a transfer request by reference"
api: "GET /v1/transfer-requests/reference/{reference}"
description: "Get a transfer request by reference"
---

## Overview

Get a transfer request by reference
...
const response = await fetch('https://api.railsfromthecrypt.com/v1/transfer-requests/reference/{reference}', {
  method: 'GET',
  headers: {
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/transfer-requests/reference/{reference}',
