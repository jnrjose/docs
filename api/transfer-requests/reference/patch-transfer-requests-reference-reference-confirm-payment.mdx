---
title: "Confirm payment for transfer request by reference"
api: "PATCH /v1/transfer-requests/reference/{reference}/confirm-payment"
description: "Confirm payment for transfer request by reference"
---

## Overview

Confirm payment for transfer request by reference
...
response = requests.patch(
    'https://api.railsfromthecrypt.com/v1/transfer-requests/reference/{reference}/confirm-payment',
