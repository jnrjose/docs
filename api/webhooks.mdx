---
title: "Get webhook for the current client"
api: "GET /v1/webhooks"
description: "Retrieve the single webhook for the current client"
---

## Overview

Retrieve the single webhook for the current client
...
<ResponseField name="message" type="string">
  No webhook found for this client
</ResponseField>
