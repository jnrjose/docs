---
title: "Create a new IP whitelist entry"
api: "POST /v1/ips"
description: "Add a new IP address to the whitelist for the current client"
---

## Overview

Add a new IP address to the whitelist for the current client
...
<ResponseField name="message" type="string">
  IP whitelist entry created successfully
</ResponseField>
