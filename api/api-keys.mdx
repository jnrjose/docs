---
title: "Get all API keys for the current client"
api: "GET /v1/api-keys"
description: "Retrieve all API keys with pagination and filtering"
---

## Overview

Retrieve all API keys with pagination and filtering
...
<ParamField query="label_filter" type="string" >
  Label Filter
</ParamField>
