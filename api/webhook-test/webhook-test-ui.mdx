---
title: "Get webhook testing UI"
api: "GET /v1/webhook-test/ui"
description: "Returns the HTML interface for testing webhooks (available in local environment)"
---

## Overview

Returns the HTML interface for testing webhooks (available in local environment)
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/webhook-test/ui
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/webhook-test/ui', {
  method: 'GET',
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/webhook-test/ui'
)
