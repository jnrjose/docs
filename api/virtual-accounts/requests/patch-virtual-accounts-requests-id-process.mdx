---
title: "Approve or reject a virtual account request"
api: "PATCH /v1/virtual-accounts/requests/{id}/process"
description: "Admin service endpoint for processing virtual account requests. When approved, a virtual account will be created and the virtual account ID will be returned in the response. Requires service API key authentication."
---

## Overview

Admin service endpoint for processing virtual account requests. When approved, a virtual account will be created and the virtual account ID will be returned in the response. Requires service API key authentication.
...
<ParamField header="x-service-api-key" type="string" required>
  Service API key for authentication (e.g., xd1234567890)
</ParamField>
...
<ResponseField name="message" type="string">
  Virtual account request processed successfully
</ResponseField>

<ResponseField name="data" type="object">
  Response data (VirtualAccountRequestResponseDto)
</ResponseField>
...
<ResponseField name="message" type="string">
  Unauthorized - Invalid or missing service API key
</ResponseField>
...
```bash cURL
curl -X PATCH https://api.railsfromthecrypt.com/v1/virtual-accounts/requests/{id}/process \
...
const response = await fetch('https://api.railsfromthecrypt.com/v1/virtual-accounts/requests/{id}/process', {
  method: 'PATCH',
  headers: {
...
response = requests.patch(
    'https://api.railsfromthecrypt.com/v1/virtual-accounts/requests/{id}/process',
