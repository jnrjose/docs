...
api: "POST /v1/virtual-accounts/request/account"
description: "Create a virtual account request for the current client."
---

## Overview

Create a virtual account request for the current client.
...
<ResponseField name="message" type="string">
  Virtual account request created successfully
</ResponseField>
...
```bash cURL
curl -X POST https://api.railsfromthecrypt.com/v1/virtual-accounts/request/account \
...
const response = await fetch('https://api.railsfromthecrypt.com/v1/virtual-accounts/request/account', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://api.railsfromthecrypt.com/v1/virtual-accounts/request/account',
