---
title: "Get all virtual account requests for the current client"
api: "GET /v1/virtual-accounts/requests"
description: "Retrieve a paginated list of all virtual account requests submitted by the authenticated client. Once approved, the virtual account ID will be available in the response for accessing the created virtual account."
---

## Overview

Retrieve a paginated list of all virtual account requests submitted by the authenticated client. Once approved, the virtual account ID will be available in the response for accessing the created virtual account.
...
<ResponseField name="message" type="string">
  Virtual account requests fetched successfully
</ResponseField>

<ResponseField name="data" type="object">
  Response data (VirtualAccountRequestPaginatedResponseDto)
</ResponseField>
