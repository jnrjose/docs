---
title: "Get metrics for the client"
api: "GET /v1/virtual-accounts/metrics"
description: "Retrieve metrics for the authenticated client."
---

## Overview

Retrieve metrics for the authenticated client.
...
<ResponseField name="message" type="string">
  Virtual account metrics fetched successfully
</ResponseField>
...
<ResponseField name="message" type="string">
  Virtual account metrics not found
</ResponseField>
