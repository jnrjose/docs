...
description: "Submit a request to create a new virtual account for receiving payments. The request will be reviewed and processed by administrators."
---

## Overview

Submit a request to create a new virtual account for receiving payments. The request will be reviewed and processed by administrators.
