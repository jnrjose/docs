---
title: "Get all activities for a virtual account"
api: "GET /v1/virtual-accounts/{id}/activities"
description: "Retrieve a paginated list of all activities and transactions associated with a virtual account, including payment events, transaction metadata, and activity timeline."
---

## Overview

Retrieve a paginated list of all activities and transactions associated with a virtual account, including payment events, transaction metadata, and activity timeline.
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/virtual-accounts/{id}/activities \
  -H "X-API-Key: your-api-key-here"
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/virtual-accounts/{id}/activities', {
  method: 'GET',
  headers: {
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/virtual-accounts/{id}/activities',
