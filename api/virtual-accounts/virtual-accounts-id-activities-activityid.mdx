---
title: "Get a single activity for a virtual account"
api: "GET /v1/virtual-accounts/{id}/activities/{activityId}"
description: "Retrieve detailed information about a specific activity associated with a virtual account, including payment events, transaction metadata, and activity details."
---

## Overview

Retrieve detailed information about a specific activity associated with a virtual account, including payment events, transaction metadata, and activity details.
...
<ResponseField name="message" type="string">
  Virtual account activity fetched successfully
</ResponseField>
...
<ResponseField name="message" type="string">
  Virtual account or activity not found
</ResponseField>
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/virtual-accounts/{id}/activities/{activityId} \
  -H "X-API-Key: your-api-key-here"
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/virtual-accounts/{id}/activities/{activityId}', {
  method: 'GET',
  headers: {
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/virtual-accounts/{id}/activities/{activityId}',
