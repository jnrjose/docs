...
api: "PUT /v1/virtual-accounts/{id}/suspend"
description: "Admin service endpoint for suspending a virtual account. Requires service API key authentication."
---

## Overview

Admin service endpoint for suspending a virtual account. Requires service API key authentication.
...
```bash cURL
curl -X PUT https://api.railsfromthecrypt.com/v1/virtual-accounts/{id}/suspend \
...
const response = await fetch('https://api.railsfromthecrypt.com/v1/virtual-accounts/{id}/suspend', {
  method: 'PUT',
  headers: {
...
response = requests.put(
    'https://api.railsfromthecrypt.com/v1/virtual-accounts/{id}/suspend',
