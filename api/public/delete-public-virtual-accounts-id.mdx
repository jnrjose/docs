...
api: "DELETE /v1/public/virtual-accounts/{id}"
description: "Suspend a virtual account for the authenticated client"
---

## Overview

Suspend a virtual account for the authenticated client
...
```bash cURL
curl -X DELETE https://api.railsfromthecrypt.com/v1/public/virtual-accounts/{id}
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/public/virtual-accounts/{id}', {
  method: 'DELETE',
...
response = requests.delete(
    'https://api.railsfromthecrypt.com/v1/public/virtual-accounts/{id}'
)
