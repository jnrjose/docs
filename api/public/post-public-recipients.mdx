---
title: "Create a new recipient (crypto or fiat)"
api: "POST /v1/public/recipients"
description: "Create a new recipient (crypto or fiat)"
---
...
```bash cURL
curl -X POST https://api.railsfromthecrypt.com/v1/public/recipients \
