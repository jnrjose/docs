---
title: "Get all recipients for the current client"
api: "GET /v1/public/recipients"
description: "Get all recipients for the current client"
---

## Overview

Get all recipients for the current client
...
<ParamField query="type" type="string" >
  Recipient type e.g crypto, fiat
</ParamField>
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/public/recipients
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/public/recipients', {
  method: 'GET',
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/public/recipients'
)
