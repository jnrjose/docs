---
title: "Lookup an account by account number and bank code"
api: "POST /v1/public/banks/lookup"
...
```bash cURL
curl -X POST https://api.railsfromthecrypt.com/v1/public/banks/lookup \
...
const response = await fetch('https://api.railsfromthecrypt.com/v1/public/banks/lookup', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://api.railsfromthecrypt.com/v1/public/banks/lookup',
