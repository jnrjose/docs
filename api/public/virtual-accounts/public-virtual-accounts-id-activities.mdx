---
title: "Get a virtual account activities by ID"
api: "GET /v1/public/virtual-accounts/{id}/activities"
description: "Get a virtual account activities by ID"
---

## Overview

Get a virtual account activities by ID
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/public/virtual-accounts/{id}/activities
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/public/virtual-accounts/{id}/activities', {
  method: 'GET',
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/public/virtual-accounts/{id}/activities'
)
