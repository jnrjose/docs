...
api: "POST /v1/public/virtual-accounts"
description: "Creates a new virtual account for the authenticated client"
---

## Overview

Creates a new virtual account for the authenticated client
...
```bash cURL
curl -X POST https://api.railsfromthecrypt.com/v1/public/virtual-accounts \
