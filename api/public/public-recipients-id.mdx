---
title: "Get a recipient by ID"
api: "GET /v1/public/recipients/{id}"
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/public/recipients/{id}
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/public/recipients/{id}', {
  method: 'GET',
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/public/recipients/{id}'
)
