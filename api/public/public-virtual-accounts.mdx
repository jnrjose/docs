---
title: "Get all virtual accounts for the authenticated client"
api: "GET /v1/public/virtual-accounts"
description: "Retrieve paginated list of virtual accounts for the authenticated client"
---

## Overview

Retrieve paginated list of virtual accounts for the authenticated client
...
<ParamField query="currency" type="string" >
  Currency for the virtual account e.g USD, NGN, CAD
</ParamField>
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/public/virtual-accounts
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/public/virtual-accounts', {
  method: 'GET',
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/public/virtual-accounts'
)
