---
title: "Get a virtual account by ID"
api: "GET /v1/virtual-accounts/{id}"
description: "Retrieve detailed information about a specific virtual account including account details, bank information, and current status."
---

## Overview

Retrieve detailed information about a specific virtual account including account details, bank information, and current status.
...
<ResponseField name="data" type="object">
  Response data (VirtualAccountResponseDto)
</ResponseField>
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/virtual-accounts/{id} \
  -H "X-API-Key: your-api-key-here"
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/virtual-accounts/{id}', {
  method: 'GET',
  headers: {
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/virtual-accounts/{id}',
