---
title: "Get KYB documents for a client"
api: "GET /v1/client/kyb/documents"
description: "Get KYB documents for a client"
---

## Overview

Get KYB documents for a client
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/client/kyb/documents \
