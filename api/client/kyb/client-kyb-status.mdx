---
title: "Get KYB status for a client"
api: "GET /v1/client/kyb/status"
description: "Get KYB status for a client"
---

## Overview

Get KYB status for a client
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/client/kyb/status \
  -H "X-API-Key: your-api-key-here"
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/client/kyb/status', {
  method: 'GET',
  headers: {
