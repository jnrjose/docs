...
<ResponseField name="data" type="object">
  Response data (RecipientResponseDto)
</ResponseField>
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/recipients/{id} \
  -H "X-API-Key: your-api-key-here"
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/recipients/{id}', {
  method: 'GET',
  headers: {
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/recipients/{id}',
