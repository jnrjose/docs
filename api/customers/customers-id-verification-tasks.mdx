...
description: "Get customer verification tasks"
---
...
<ResponseField name="message" type="string">
  Customer verification tasks fetched successfully
</ResponseField>
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/customers/{id}/verification-tasks \
  -H "X-API-Key: your-api-key-here"
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/customers/{id}/verification-tasks', {
  method: 'GET',
  headers: {
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/customers/{id}/verification-tasks',
