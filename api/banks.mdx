...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/banks \
  -H "X-API-Key: your-api-key-here"
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/banks', {
  method: 'GET',
  headers: {
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/banks',
