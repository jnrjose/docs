---
title: "Get a specific IP whitelist entry by ID"
api: "GET /v1/ips/{id}"
description: "Retrieve a single IP whitelist entry by its ID"
---

## Overview

Retrieve a single IP whitelist entry by its ID
...
<ResponseField name="message" type="string">
  IP whitelist entry retrieved successfully
</ResponseField>

<ResponseField name="data" type="object">
  Response data (IpResponseDto)
</ResponseField>
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/ips/{id} \
  -H "X-API-Key: your-api-key-here"
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/ips/{id}', {
  method: 'GET',
  headers: {
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/ips/{id}',
