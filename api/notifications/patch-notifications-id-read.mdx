---
title: "Mark specific notification as read"
...
```bash cURL
curl -X PATCH https://api.railsfromthecrypt.com/v1/notifications/{id}/read \
  -H "X-API-Key: your-api-key-here" \
  -H "Content-Type: application/json"
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/notifications/{id}/read', {
  method: 'PATCH',
  headers: {
...
response = requests.patch(
    'https://api.railsfromthecrypt.com/v1/notifications/{id}/read',
