---
title: "Submit a new career request"
api: "POST /v1/landing/career"
description: "Submit a new career request"
---

## Overview

Submit a new career request

## Request

<ParamField header="x-idempotency-key" type="string" required>
  Unique key to prevent duplicate submissions
</ParamField>

<ParamField header="x-demo-api-key" type="string" required>
  Career API key for authentication
</ParamField>
...
<ResponseField name="data" type="object">
  Response data (DemoFormResponseDto)
</ResponseField>
...
<ResponseField name="message" type="string">
  Bad request - validation failed or missing idempotency key
</ResponseField>
...
<ResponseField name="message" type="string">
  Unauthorized - invalid career API key
</ResponseField>
...
response = requests.post(
    'https://api.railsfromthecrypt.com/v1/landing/career',
