---
title: "Get a transfer request by ID"
api: "GET /v1/transfer-requests/{id}"
description: "Get a transfer request by ID"
---
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/transfer-requests/{id} \
  -H "X-API-Key: your-api-key-here"
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/transfer-requests/{id}', {
  method: 'GET',
  headers: {
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/transfer-requests/{id}',
