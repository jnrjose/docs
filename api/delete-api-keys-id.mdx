---
title: "Delete an API key (requires password confirmation)"
api: "DELETE /v1/api-keys/{id}"
description: "Delete an API key (requires password confirmation)"
---

## Overview

Delete an API key (requires password confirmation)
...
```bash cURL
curl -X DELETE https://api.railsfromthecrypt.com/v1/api-keys/{id} \
  -H "X-API-Key: your-api-key-here"
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/api-keys/{id}', {
  method: 'DELETE',
  headers: {
...
response = requests.delete(
    'https://api.railsfromthecrypt.com/v1/api-keys/{id}',
