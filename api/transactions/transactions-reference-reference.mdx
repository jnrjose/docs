---
title: "Get a specific transaction by reference"
api: "GET /v1/transactions/reference/{reference}"
description: "Get a specific transaction by reference"
---
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/transactions/reference/{reference} \
