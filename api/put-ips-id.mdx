---
title: "Update an IP whitelist entry"
api: "PUT /v1/ips/{id}"
description: "Update an existing IP whitelist entry by ID"
---

## Overview

Update an existing IP whitelist entry by ID
...
```bash cURL
curl -X PUT https://api.railsfromthecrypt.com/v1/ips/{id} \
