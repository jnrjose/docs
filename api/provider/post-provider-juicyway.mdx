---
title: "Webhook for Juicyway provider"
api: "POST /v1/provider/juicyway"
description: "Receives webhook notifications from Juicyway for payment events, virtual account transactions, and other account activities."
---

## Overview

Receives webhook notifications from Juicyway for payment events, virtual account transactions, and other account activities.
...
<ResponseField name="message" type="string">
  Juicyway webhook processed successfully
</ResponseField>
...
```bash cURL
curl -X POST https://api.railsfromthecrypt.com/v1/provider/juicyway \
  -H "Content-Type: application/json"
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/provider/juicyway', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://api.railsfromthecrypt.com/v1/provider/juicyway',
