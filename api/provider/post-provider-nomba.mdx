---
title: "Webhook for Nomba provider"
api: "POST /v1/provider/nomba"
description: "Receives webhook notifications from Nomba for payment events, virtual account transactions, and other account activities."
---

## Overview

Receives webhook notifications from Nomba for payment events, virtual account transactions, and other account activities.
...
<ResponseField name="message" type="string">
  Nomba webhook processed successfully
</ResponseField>
...
const response = await fetch('https://api.railsfromthecrypt.com/v1/provider/nomba', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://api.railsfromthecrypt.com/v1/provider/nomba',
