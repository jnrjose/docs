---
title: "Get user"
api: "GET /v1/provider/sumsub/user"
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/provider/sumsub/user
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/provider/sumsub/user', {
  method: 'GET',
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/provider/sumsub/user'
)
