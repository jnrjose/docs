---
title: "Verify user"
api: "GET /v1/provider/sumsub/user/verify"
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/provider/sumsub/user/verify
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/provider/sumsub/user/verify', {
  method: 'GET',
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/provider/sumsub/user/verify'
)
