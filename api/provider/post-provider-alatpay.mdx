---
title: "Webhook for Alatpay provider"
api: "POST /v1/provider/alatpay"
description: "Receives webhook notifications from Alatpay for payment events, virtual account transactions, and other account activities."
---

## Overview

Receives webhook notifications from Alatpay for payment events, virtual account transactions, and other account activities.
...
<ResponseField name="message" type="string">
  Alatpay webhook processed successfully
</ResponseField>
...
```bash cURL
curl -X POST https://api.railsfromthecrypt.com/v1/provider/alatpay \
...
const response = await fetch('https://api.railsfromthecrypt.com/v1/provider/alatpay', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://api.railsfromthecrypt.com/v1/provider/alatpay',
