---
title: "Webhook for Bridge provider"
api: "POST /v1/provider/bridge"
description: "Webhook for Bridge provider"
---

## Overview

Webhook for Bridge provider
...
<ResponseField name="message" type="string">
  Bridge webhook processed successfully
</ResponseField>
...
const response = await fetch('https://api.railsfromthecrypt.com/v1/provider/bridge', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://api.railsfromthecrypt.com/v1/provider/bridge',
