---
title: "Get all IP whitelist entries for the current client"
api: "GET /v1/ips"
description: "Retrieve all IP whitelist entries with pagination and filtering"
---

## Overview

Retrieve all IP whitelist entries with pagination and filtering
...
<ParamField query="ip_filter" type="string" >
  Ip Filter
</ParamField>
...
<ResponseField name="message" type="string">
  IP whitelist entries retrieved successfully
</ResponseField>
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/ips',
