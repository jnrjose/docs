---
title: "GET /v1/transactions/{id}"
api: "GET /v1/transactions/{id}"
description: "GET request to /v1/transactions/{id}"
---

## Overview

This endpoint handles GET requests to /v1/transactions/{id}.
...
```bash cURL
curl -X GET https://api.railsfromthecrypt.com/v1/transactions/{id}
```

```javascript JavaScript
const response = await fetch('https://api.railsfromthecrypt.com/v1/transactions/{id}', {
  method: 'GET',
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/transactions/{id}'
)
