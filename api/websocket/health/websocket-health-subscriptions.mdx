---
title: "Get websocket subscriptions"
api: "GET /v1/websocket/health/subscriptions"
description: "Get statistics about websocket subscriptions by type"
---

## Overview

Get statistics about websocket subscriptions by type
...
<ResponseField name="message" type="string">
  Websocket subscriptions retrieved successfully
</ResponseField>
...
const response = await fetch('https://api.railsfromthecrypt.com/v1/websocket/health/subscriptions', {
  method: 'GET',
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/websocket/health/subscriptions'
)
