---
title: "Get websocket connections"
api: "GET /v1/websocket/health/connections"
...
<ResponseField name="message" type="string">
  Websocket connections retrieved successfully
</ResponseField>
...
const response = await fetch('https://api.railsfromthecrypt.com/v1/websocket/health/connections', {
  method: 'GET',
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/websocket/health/connections'
)
