---
title: "Get websocket health status"
api: "GET /v1/websocket/health"
description: "Get the overall health status of the websocket service"
---

## Overview

Get the overall health status of the websocket service
...
<ResponseField name="message" type="string">
  Websocket health status retrieved successfully
</ResponseField>
...
response = requests.get(
    'https://api.railsfromthecrypt.com/v1/websocket/health'
)
